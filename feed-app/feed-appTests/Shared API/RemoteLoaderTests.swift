...
final class RemoteLoaderTests: XCTestCase {
    ...
    func test_load_doesNotDeliverResultAfterSUTDeallocated() {
        ...
        var sut: RemoteLoader? = RemoteLoader(url: URL(string: "http://a-url.com")!, client: client)
    ...
    private func makeSUT(url: URL = URL(string: "http://a-url.com")!, file: StaticString = #filePath, line: UInt = #line) -> (RemoteLoader, HTTPClientSpy) {
        let client = HTTPClientSpy()
