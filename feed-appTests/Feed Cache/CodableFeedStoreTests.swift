...
class CodableFeedStoreTests: XCTestCase {
    ...
    func test_insert_deliversErrorOnInsertionError() {
        ...
        XCTAssertNotNil(insertionError, "Expection cache assertion to fail with an error")
    }
    ...
    func test_storeSideEffects_runSerially() {
        ...
        XCTAssertEqual(completedOperationsInOrder, [op1, op2, op3], "Expected operations to complete serially")
    }
